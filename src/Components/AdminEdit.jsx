...
function AdminEdit({ tours }) {
    ...
    return (
        <>
            <button className='btn me-3 mt-3 bg-info text-white' onClick={handleShow}>
               EDIT
            </button>
                    ...
                    <Row>
                        <Col md='6'>
                            <label className='h-75'>
                                <input type="file" style={{display:'none'}} name='img' onChange={(e) => { setTourData({ ...tourData, image: e.target.files[0] }) }} />
